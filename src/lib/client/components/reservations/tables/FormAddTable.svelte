...
<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
    <div class="bg-white rounded-lg p-6 max-w-md w-full">
      <h2 class="text-xl font-bold mb-4">Añadir Mesa</h2>
      ...
      <div class="space-y-4">
        ...
        <div>
            ...
            <select id="section" bind:value={newTable.section} class="mt-1 block w-full border-b-2 border-gray-300 shadow-sm focus:border-gray-500 focus:ring focus:ring-gray-200 focus:ring-opacity-50 text-sm md:text-lg">
          ...
          <div class="mt-1">
            <label class="inline-flex items-center">
              <input
                id="available"
                type="checkbox"
                bind:checked={newTable.available}
