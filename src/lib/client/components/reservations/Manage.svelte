<script lang="ts">
  ...
  async function handleCancel(id: mongoose.Types.ObjectId) {
    const reservation = userReservations.find((r) => r._id === id);
    ...
    //   alert(
    //     `Las cancelaciones deben realizarse con al menos ${reservationSettings.cancellationDays} días de antelación`
    //   );
    //   return;
    // }
...
<div class="container mx-auto px-4 py-12 max-w-4xl">
  <div class="bg-white rounded-lg shadow-lg p-8">
    <h1 class="text-3xl font-bold mb-8 text-center text-gradient">
      Gestionar Reservas
    </h1>
